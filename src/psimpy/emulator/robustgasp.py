...
class RobustGaSPBase:
    ...
    def _preprocess_design_response_trend(
        self, design: np.ndarray, response: np.ndarray, trend: Union[None, np.ndarray]
    ) -> None:
        """
    ...
    def _preprocess_testing_input_trend(
        self, testing_input: np.ndarray, testing_trend: Union[None, np.ndarray]
    ) -> None:
        """
...
class ScalarGaSP(RobustGaSPBase):
    ...
    def get_trend_param(self):
        theta_hat = r_at(self.emulator, "theta_hat")
        return theta_hat
